  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <header className="bg-gradient-to-r from-black to-blue-400">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row items-center justify-between text-center sm:text-right">
          <img
            src={logo}
            alt="Logo"
            className="h-40 sm:h-32 md:h-32 lg:h-36 xl:h-40 sm:mb-0"
          />
          <img
            src={titulo}
            alt="titulo"
            className="h-56 sm:h-56 md:h-56 lg:h-56 xl:h-64"
          />
        </div>
      </header>
      ...
      <main className="flex-grow px-2 py-6 bg-blue-200 text-center">
        ...
        <section className="border-8 border-blue-900 relative bg-gradient-to-r from-purple-500 via-red-500 to-yellow-500 container rounded-3xl shadow-xl shadow-black z-50 transform transition-all duration-500 hover:scale-105 hover:shadow-3xl mx-auto mb-12 p-8 sm:p-12">
          {/* Indicador de Nuevo Evento */}
          <div className="absolute top-4 left-4 bg-black text-white text-[10px] sm:text-xs md:text-sm lg:text-base font-bold px-3 py-1 rounded-full shadow-md">
            Nuevo evento externo | 2025
          </div>
          <div className="container  mt-4 mx-auto text-center text-white">
            <h2 className="text-4xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold uppercase tracking-wide mb-4 sm:mb-6">
              <span className="text-black px-3 py-1 rounded-md">
                GarajeVision
              </span>
            </h2>
            <span className="text-purple-900 px-3 py-1 rounded-md sm:text-xs md:text-sm lg:text-base font-bold">
              2ª Edición
            </span>
            <p className="text-sm sm:text-2xl md:text-2xl lg:text-2xl font-medium mb-6 sm:mb-8 text-black">
              ¡Próximamente!
            </p>
            <Link to="/GarajeVision">
              <button className="inline-block bg-indigo-100 text-black font-bold text-sm sm:text-base md:text-lg lg:text-xl px-6 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg transition-all duration-300 hover:bg-black hover:text-white hover:shadow-2xl">
                Más Información
              </button>
            </Link>
          </div>
          ...
          <div className="absolute -bottom-10 -left-10 h-36 w-36 sm:h-48 sm:w-48 bg-white/10 rounded-full blur-3xl animate-pulse"></div>
        </section>
        ...
        <section className="container mx-auto rounded-3xl shadow-xl shadow-black z-50 mt-12">
          ...
          <div className="relative p-6 mb-12 rounded-b-3xl bg-gradient-to-r from-black to-blue-600 shadow-black z-0 text-white font">
            <p className="text-justify-center mb-4">
              Somos dos jóvenes apasionados por la{" "}
              <span className="font-bold text-blue-300">tecnología</span>, y
              hemos creado{" "}
              <span className="font-bold text-blue-300">Viper3D</span> para
              acercar la{" "}
              <span className="font-bold text-blue-300">impresión 3D</span> a
              todos.
            </p>
            <p className="text-justify-center mb-4">
              Ofrecemos modelos{" "}
              <span className="font-bold text-blue-300">STL</span> y servicios
              de impresión en{" "}
              <span className="font-bold text-blue-300">PLA</span>, un material
              ecológico y sostenible. Creemos en la accesibilidad y en el
              respeto por el medio ambiente.
            </p>
            <p className="text-justify-center mb-4">
              Con <span className="font-bold text-blue-300">Viper3D</span>,
              puedes dar vida a tus ideas, sin importar tu nivel de experiencia.
              ¡Únete a nosotros y descubre el poder transformador de la{" "}
              <span className="font-bold text-blue-300">impresión 3D</span>!
            </p>
            <p className="text-justify-center">
              Necesitas algo a medida? Contáctanos en nuestras redes sociales o
              mándanos un mail a:{" "}
              <span className="font-extrabold text-blue-300">
                info.viper3d@gmail.com
              </span>
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto rounded-3xl shadow-xl shadow-black z-50">
          ...
          <div className="relative p-2 mb-12 rounded-b-3xl bg-gradient-to-r from-black to-blue-400">
            <div className="relative overflow-hidden">
              <div
                ...
                style={{
                  transform: `translateX(-${
                    currentSlide * (100 / (window.innerWidth < 1024 ? 2 : 4))
                  }%)`,
                }}
              >
                {slides.concat(slides).map((slide, index) => (
                  <div
                    ...
                    style={{
                      width: `${window.innerWidth < 1024 ? "50%" : "25%"}`,
                    }}
                  >
                    <div
                      className="flex justify-center items-center"
                      onMouseEnter={() =>
                        setHoveredIndex(index % slides.length)
                      }
                    ...
                    >
                      <div className="relative">
                        <img
                          src={slide.src}
                          alt={slide.alt}
                          className={`w-full object-contain rounded-3xl transition-opacity duration-1000 ${
                        ...
                        <img
                          src={slide.hoverSrc}
                          alt={`${slide.alt}-hover`}
                          className={`w-full object-contain rounded-3xl transition-opacity duration-1000 absolute top-0 left-0 ${
                            hoveredIndex === index % slides.length
                              ? "opacity-100"
                              : "opacity-0"
                          }`}
              ...
              <button
                onClick={handlePrev}
                className="absolute top-1/2 transform -translate-y-1/2 left-0 p-2 bg-gray-700 text-white rounded-full hover:bg-gray-800 transition"
              >
                &lt;
              </button>
              <button
                onClick={handleNext}
                className="absolute top-1/2 transform -translate-y-1/2 right-0 p-2 bg-gray-700 text-white rounded-full hover:bg-gray-800 transition"
              >
                &gt;
              </button>
            </div>
        ...
        <section className=" container mx-auto rounded-3xl shadow-xl shadow-black z-50">
          <h2 className="p-4 bg-gradient-to-r from-black to-blue-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-white rounded-t-3xl">
            Modelos <span className="font-bold text-blue-300">STL</span> e
            impresión en <span className="font-bold text-blue-300">PLA</span>
          </h2>
          <div className="relative p-6 mb-12 rounded-b-3xl grid grid-cols-1 sm:grid-cols-2 gap-8 bg-gradient-to-r from-black to-blue-400  ">
            <div className="bg-indigo-300 p-6 rounded-3xl shadow-2xl flex flex-col items-center transform transition duration-500 hover:scale-105 hover:bg-indigo-400">
              ...
              <p className="text-md font-semibold text-black-700 mb-4">
                Explora y compra nuestros modelos STL en Cults 3D.
              </p>
              <p className="text-md font-semibold text-black-700 mb-4">
                +1000 Descargas
              </p>
            ...
            <div className="bg-orange-300 p-6 rounded-3xl shadow-2xl flex flex-col items-center transform transition duration-500 hover:scale-105 hover:bg-orange-400">
              ...
              <p className="text-md font-semibold text-black-700 mb-4">
                Descubre nuestros modelos 3D impresos en Etsy.
              </p>
              <p className="text-md font-semibold text-black-700 mb-4">
              ...
              <div className="flex items-center pb-2">
                {Array(5)
                  ...
                  .map((_, i) => (
                    <svg
                      key={i}
                      className="w-4 h-4 text-blue-400 me-1"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 22 20"
              ...
              <a
                href="https://www.etsy.com/es/shop/Viper3Des"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 font-bold underline hover:text-blue-800 transition duration-300"
              >
        ...
        <section className="container mx-auto rounded-3xl shadow-xl shadow-black z-50 mt-12">
          <h2 className="p-4 bg-gradient-to-r from-black to-blue-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-white rounded-t-3xl">
            ...
            <span className="font-bold text-blue-300">Clientes</span>
          </h2>
          <div className="relative p-6 mb-12 rounded-b-3xl grid grid-cols-1 sm:grid-cols-2 gap-8 bg-gradient-to-r from-black to-blue-400  shadow-black z-0">
            {reviews.map((review, index) => (
              <div
                key={index}
                className="bg-blue-50 p-6 rounded-3xl shadow-2xl flex flex-col items-start"
              >
        ...
        <section className="container mx-auto rounded-3xl shadow-xl shadow-black z-50 mt-12">
          <h2 className="p-4 bg-gradient-to-r from-black to-blue-400 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-semibold text-white rounded-t-3xl">
            Síguenos en{" "}
            <span className="font-bold text-blue-300">Redes Sociales</span>
          </h2>
          <div className="relative p-6 rounded-b-3xl flex flex-col sm:flex-row justify-around items-center bg-gradient-to-r from-black to-blue-400 space-y-4 sm:space-y-0">
            <div className="m-4 bg-gray-700 w-10/12 sm:w-4/12 p-4 rounded-3xl transform transition-all duration-500 hover:scale-110 hover:bg-gray-800 hover:shadow-lg">
              <a
                href="https://www.tiktok.com/@viper3doficial"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="m-4 bg-indigo-700 w-10/12 sm:w-4/12 p-4 rounded-3xl transform transition-all duration-500 hover:scale-110 hover:bg-indigo-800 hover:shadow-lg">
              <a
                href="https://www.instagram.com/viper3doficial/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center space-y-2"
              >
            ...
            <div className="m-4 bg-red-700 w-10/12 sm:w-4/12 p-4 rounded-3xl transform transition-all duration-500 hover:scale-110 hover:bg-red-800 hover:shadow-lg">
              <a
                href="https://www.youtube.com/@viper3doficial"
                target="_blank"
                rel="noopener noreferrer"
                className="flex flex-col items-center space-y-2"
              >
      ...
      <footer className="bg-gradient-to-r from-black to-blue-400 py-4 shadow-lg z-10 shadow-black">
        <div className="container mx-auto px-6 text-center text-white">
          &copy; {new Date().getFullYear()} Viper3D. Todos los derechos
          reservados.
        </div>
      </footer>
    </div>
